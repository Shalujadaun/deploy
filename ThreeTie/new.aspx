<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="new.aspx.cs" Inherits="ThreeTie._new" %>
...
<body>
    <form id="form1" runat="server">
        ...
        UserID:<asp:TextBox ID="txuserid" runat="server"></asp:TextBox>
        ...
        <br />
        <br />
        Password:<asp:TextBox ID="txpassword" TextMode="Password" runat="server"></asp:TextBox>
